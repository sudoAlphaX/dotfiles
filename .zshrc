...
plugins=(gpg-agent git aliases alias-finder colored-man-pages command-not-found extract universalarchive virtualenvwrapper zsh-syntax-highlighting tmux)
