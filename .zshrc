...
plugins=(sudo gpg-agent git gitignore git-auto-fetch aliases alias-finder colored-man-pages command-not-found extract universalarchive virtualenvwrapper tmux z zsh-syntax-highlighting)
