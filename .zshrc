...
plugins=(sudo gpg-agent git aliases alias-finder colored-man-pages command-not-found extract universalarchive virtualenvwrapper tmux zsh-syntax-highlighting)
